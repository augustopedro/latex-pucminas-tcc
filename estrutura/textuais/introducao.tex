...
Este documento é um \emph{template} \LaTeX{} que foi concebido, primariamente, para ser utilizado na elaboração de Trabalho de Conclusão de Curs em conformidade com as normas da Pontifícia Universidade Católica de Minas Gerais.

Para a produção deste \emph{template} foi necessário adaptar o arquivo {\ttfamily abntex2.cls}. Assim, foi produzido o arquivo {\ttfamily pucminas-abntex2.cls} que define o \verb|documentclass| específico para a PUC Minas.
...
A compilação para gerar um arquivo no formato pdf, incluindo corretamente as referências bibliográficas, deve ser realizada utilizando o comando \verb|makefile|, disponível na mesma pasta onde está o arquivo principal \verb|pucminas-tcc.tex|. Caso seja alterado o nome do arquivo \verb|pucminas-tcc.tex|, deverá ser alterado no arquivo \verb|makefile| também.
